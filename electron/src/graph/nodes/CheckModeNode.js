...
`;
        ...
        for await (const message of repositoryAnalysisProvider.execute(repositoryAnalysisPrompt, {
            maxTurns,
...
`;
                ...
                try {
                    await gitManager.addAndCommit('.kugutsu/repository/', 'chore: Initialize repository specifications\n\n🤖 Generated with Kugutsu 2.0\n\nCo-Authored-By: Claude <noreply@anthropic.com>');
                }
                catch (commitError) {
