...
export async function reviewStoryMappingNode(state) {
    ...
    const totalStories = storyMapping.epics.reduce((sum, epic) => sum + epic.stories.length, 0);
 ...
 * レビュープロンプトを構築
 */
function buildReviewPrompt(storyMapping, iteration) {
    return `
...
//# sourceMappingURL=ReviewStoryMappingNode.js.map