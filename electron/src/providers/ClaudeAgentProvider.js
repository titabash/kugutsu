...
export class ClaudeAgentProvider {
    ...
    async *execute(prompt, options = {}) {
        const { maxTurns = 30, cwd = process.cwd(), allowedTools, disallowedTools, permissionMode = 'default', resume, model, systemPrompt, includePartialMessages = false, providerOptions = {}, } = options;
        try {
            // Build query options
            const queryOptions = {
