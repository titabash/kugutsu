...
export class FallbackAIProvider {
     ...
     */
    constructor(primaryProvider, fallbackProvider, enableFallback = true) {
    ...
    async *execute(prompt, options = {}) {
        ...
        if (handler.getHasError()) {
            ...
            if (this.enableFallback &&
                ...
                console.log(ProviderFallbackManager.getFallbackMessage(details, primaryProviderName, fallbackProviderName));
                ...
                if (handler2.getHasError()) {
                    ...
                    const errorMsg = `両方のAIプロバイダーが失敗しました。処理を継続できません。\n` +
...
//# sourceMappingURL=FallbackAIProvider.js.map