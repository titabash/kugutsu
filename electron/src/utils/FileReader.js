...
export class FileReader {
    ...
    async readJSON(relativePath) {
        ...
        try {
            ...
            if (error instanceof SyntaxError) {
                throw new Error(`Failed to parse JSON file: ${fullPath}\n` +
                    `Reason: ${error.message}`);
            }
            throw new Error(`Failed to read JSON file: ${fullPath}\n` +
    ...
    async readMarkdown(relativePath) {
        ...
        try {
            ...
            throw new Error(`Failed to read Markdown file: ${fullPath}\n` +
                `Reason: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
    ...
    async listFiles(relativePath = '') {
        ...
        try {
            ...
            throw new Error(`Failed to list files in directory: ${fullPath}\n` +
                `Reason: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
    ...
    async listDirectories(relativePath = '') {
        ...
        try {
            ...
            throw new Error(`Failed to list directories in: ${fullPath}\n` +
                `Reason: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
    ...
    async stat(relativePath) {
        ...
        try {
            ...
            throw new Error(`Failed to get file stats: ${fullPath}\n` +
                `Reason: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
}
