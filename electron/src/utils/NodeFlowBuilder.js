 ...
 */
export function buildUnifiedScrumWorkflowFlow() {
    const nodes = [
        // エントリーポイント
 ...
 * ノードフロー情報の複製を作成
 */
export function cloneNodeFlowData(flowData) {
    return {
 ...
 */
export function resetNodeFlow(flowData) {
...
//# sourceMappingURL=NodeFlowBuilder.js.map