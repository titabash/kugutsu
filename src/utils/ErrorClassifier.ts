import { ErrorSeverity, ClassifiedError } from '../types/errors.js';
...
export class ErrorClassifier {
   ...
   * リトライ可能なエラーを示すキーワード
   */
  private static readonly RETRYABLE_KEYWORDS = [
    'etimedout',
    'econnreset',
    'econnrefused',
    'rate_limit',
   ...
   * 復旧可能なエラーを示すキーワード
   */
  private static readonly RECOVERABLE_KEYWORDS = [
    'conflict',
    'permission denied',
    'locked',
    'eacces',
   ...
   */
  static isRetryable(classified: ClassifiedError): boolean {
   ...
   */
  static isRecoverable(classified: ClassifiedError): boolean {
   ...
   */
  static isPermanent(classified: ClassifiedError): boolean {
